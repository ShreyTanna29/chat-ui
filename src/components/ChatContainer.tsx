...
import { Code, Lightbulb, BookOpen, Zap, ArrowUpRight, Wand2 } from 'lucide-react'
...
export function ChatContainer({ messages, isLoading, onSend }: ChatContainerProps) {
  ...
  return (
    <div className="flex w-full flex-col justify-center items-center h-full bg-background relative overflow-hidden">
      ...
      {/* Messages area */}
      <div ref={scrollRef} className="flex-1 overflow-y-auto relative z-10 scroll-smooth w-full">
        {isEmpty ? (
          ...
          <div className="flex flex-col items-center justify-center h-full px-6 animate-fade-in py-10">
            ...
            <p className="text-[var(--color-text-secondary)] mb-10 text-center max-w-lg text-base animate-slide-up leading-relaxed" style={{ animationDelay: '100ms' }}>
              I'm <span className="font-semibold text-[var(--color-text-primary)]">Erudite</span>, your AI assistant. 
              Ask me anything from complex coding questions to creative writing ideas.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full max-w-4xl mb-10">
              {suggestions.map((suggestion, index) => (
                <button
                  key={index}
                  onClick={() => onSend(`${suggestion.title} ${suggestion.description}`)}
                ...
                >
                  ...
                  <div 
                    ...
                    style={{ 
                      background: `linear-gradient(135deg, ${suggestion.glowColor.replace('0.15', '0.3')}, transparent 60%)`,
                      padding: '1px',
                  ...
                  <div 
                    ...
                    style={{ 
                      background: `radial-gradient(circle at 30% 30%, ${suggestion.glowColor.replace('0.15', '0.25')}, transparent 60%)` 
                    }}
                  />
                  ...
                  <div className="relative z-10 w-full flex flex-col gap-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div 
                        ...
                        style={{
                          boxShadow: `0 4px 16px ${suggestion.glowColor.replace('0.15', '0')}, 0 0 0 0 ${suggestion.glowColor.replace('0.15', '0')}`,
                      ...
                      >
                        ...
                        <div 
                          ...
                          style={{ background: suggestion.glowColor.replace('0.15', '0.4') }}
                        />
                        <suggestion.icon 
                          size={22} 
                          className={cn(
                    ...
                    <div 
                      ...
                      style={{ 
                        background: `linear-gradient(90deg, ${suggestion.glowColor.replace('0.15', '0.6')}, transparent)` 
                      }}
                    />
                  </div>
                </button>
